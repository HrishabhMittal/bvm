...
$(OUT_DIR)/bvm: include $(SRC_DIR)/bvm.cpp | $(OUT_DIR)
	g++ -std=c++23 $(SRC_DIR)/bvm.cpp -o $(OUT_DIR)/bvm -I$(INCLUDE_DIR)

$(OUT_DIR)/objdump: include $(SRC_DIR)/objdump.cpp | $(OUT_DIR)
	g++ -std=c++23 $(SRC_DIR)/objdump.cpp -o $(OUT_DIR)/objdump -I$(INCLUDE_DIR)

$(OUT_DIR)/stdprint: include $(STD_DIR)/print.cpp | $(OUT_DIR)
	g++ -std=c++23 $(STD_DIR)/print.cpp -o $(OUT_DIR)/stdprint -I$(INCLUDE_DIR)
